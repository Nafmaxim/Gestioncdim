...
//val pati = findViewById<ImageView>(R.id.ajoutautre)
/**
...
class PatientFragment : Fragment(R.layout.fragment_patient) {
    ...
    override fun onCreateView(
        ...
        //val pati = findViewById<ImageView>(R.id.ajoutautre)
        val vie: View =  inflater.inflate(R.layout.fragment_home, container, false)
        val ajoutpat = vie.findViewById<ImageView>(R.id.ajoutpat)

        ajoutpat.setOnClickListener {
            val intentToEnrePatActivity: Intent = Intent(activity, EnrePatActivity::class.java)
